...
import 'package:suc_khoe_app/pages/PhoneAuthPage.dart';
import 'package:suc_khoe_app/pages/SignIn.dart';
import 'package:suc_khoe_app/screens/form_bmi.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              buttonItem("assets/google.svg","Đăng ký bằng Google", 25,
                  () async {await authClass.googleSignIn(context); }),
              SizedBox(height: 15,),
              buttonItem("assets/phone.svg","Đăng ký bằng SĐT",25,
                (){
    ...
    return InkWell(
      onTap: () async {
        ...
        try {
          ...
          Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(builder: (builder) => formBmi()),
                  (route) => false);
        }
        catch (e) {
          final snackbar = SnackBar(content: Text("Lỗi đăng nhập"));
